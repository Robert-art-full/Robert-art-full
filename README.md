...
<p align="center">
Desenvolvedor backend em transição de carreira com experiência real em ambientes de produção (suporte nível III).<br>
Construo aplicações utilizando Java, Spring Boot, Python, SQL e AWS, com foco em APIs REST e escalabilidade.<br>
Motivado a resolver problemas reais e evoluir continuamente como engenheiro de software.
</p>
